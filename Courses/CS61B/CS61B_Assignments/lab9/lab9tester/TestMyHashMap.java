...
public class TestMyHashMap {
    ...
    public void removeTest() {
        ...
        hashMap.remove("hi0");
        hashMap.remove("hi10", 10);
        hashMap.remove("hi29", 5);
        assertEquals(28, hashMap.size());
        assertEquals(null, hashMap.get("hi0"));
        assertEquals(null, hashMap.get("hi10"));
        assertEquals((Integer) 29, hashMap.get("hi29"));
    }
